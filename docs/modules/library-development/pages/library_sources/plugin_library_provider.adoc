...
If packaging your libraries via a Jenkins Plugin, we recommend configuring your library source as a xref:library_sources/scm_library_provider.adoc[SCM Library] during development.
