...
class PipelineConfig {
    ...
    PipelineConfigurationObject getConfig(){
      return configObject ?: new PipelineConfigurationObject()
    }

    void join(PipelineConfigurationObject child){
      /*
      ...
      */
      if(!configObject){
        configObject = child
        printJoin(child, child, new PipelineConfigurationObject(config: [:], merge: [], override: []))
        return
      }
    ...
    void printJoin(PipelineConfigurationObject outcome, PipelineConfigurationObject incoming, PipelineConfigurationObject prev){
        ...
        new TemplateLogger(owner.getListener()).print(output.join("\n"))
    }
