...
def call(CpsClosure body = null){
    ...
    TemplateLogger.printWarning "[DEBUG] entered TemplateEntryPoint.call"     
    ...
    String template
    if(!body){
        TemplateLogger.printWarning "[DEBUG] getting the pipeline template" 
        template = TemplateEntryPointVariable.getTemplate(pipelineConfig)
        TemplateLogger.printWarning "[DEBUG] got the template: \n ${template}"
    }
    ...
    try{
        ...
        TemplateLogger.printWarning "[DEBUG] Init Hooks invoked" 
